...
const colorCode = (str, theme, lang, asReactComponent) => {
  const parse = asReactComponent ? require("html-react-parser") : null;
  ...
  return asReactComponent ? parse(result, false) : result;
};
